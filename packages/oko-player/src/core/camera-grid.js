...
export class CameraGrid {
  ...
  constructor(gridEl, api) {
    ...
    /** @type {(view: CameraView) => void} Called after CameraView created, before wiring. Attach features here. */
  ...
  build(cameraConfigs) {
    ...
    for (const config of cameraConfigs) {
      ...
      // Let shell attach features before wiring callbacks
      if (this.onViewCreated) this.onViewCreated(view);
